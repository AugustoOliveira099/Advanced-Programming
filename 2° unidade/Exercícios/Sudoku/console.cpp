...
void Console::cores(CONSOLE_CORES F, CONSOLE_CORES B) const
{
  ...
  {
  default:
  case CONSOLE_CORES::DEFAULT:
    cF = 39;
    break;
  case CONSOLE_CORES::BLACK:
    cF = 30;
    break;
  case CONSOLE_CORES::RED:
    cF = 31;
    break;
  case CONSOLE_CORES::GREEN:
    cF = 32;
    break;
  case CONSOLE_CORES::YELLOW:
    cF = 33;
    break;
  case CONSOLE_CORES::BLUE:
    cF = 34;
    break;
  case CONSOLE_CORES::MAGENTA:
    cF = 35;
    break;
  case CONSOLE_CORES::CYAN:
    cF = 36;
    break;
  case CONSOLE_CORES::WHITE:
    cF = 37;
    break;
  case CONSOLE_CORES::BRIGHT_BLACK:
    cF = 90;
    break;
  case CONSOLE_CORES::BRIGHT_RED:
    cF = 91;
    break;
  case CONSOLE_CORES::BRIGHT_GREEN:
    cF = 92;
    break;
  case CONSOLE_CORES::BRIGHT_YELLOW:
    cF = 93;
    break;
  case CONSOLE_CORES::BRIGHT_BLUE:
    cF = 94;
    break;
  case CONSOLE_CORES::BRIGHT_MAGENTA:
    cF = 95;
    break;
  case CONSOLE_CORES::BRIGHT_CYAN:
    cF = 96;
    break;
  case CONSOLE_CORES::BRIGHT_WHITE:
    cF = 97;
    break;
  }
