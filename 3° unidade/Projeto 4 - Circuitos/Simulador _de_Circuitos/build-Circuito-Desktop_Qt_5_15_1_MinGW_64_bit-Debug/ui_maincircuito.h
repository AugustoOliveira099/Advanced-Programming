...
public:
    ...
    void setupUi(QMainWindow *maincircuito)
    {
        ...
        tabelaVerdadeWidget->setSizeAdjustPolicy(QAbstractScrollArea::AdjustToContents);
        ...
        tabelaVerdadeWidget->setShowGrid(true);
        tabelaVerdadeWidget->horizontalHeader()->setVisible(false);
        tabelaVerdadeWidget->horizontalHeader()->setMinimumSectionSize(10);
        tabelaVerdadeWidget->horizontalHeader()->setDefaultSectionSize(50);
        tabelaVerdadeWidget->verticalHeader()->setVisible(false);
