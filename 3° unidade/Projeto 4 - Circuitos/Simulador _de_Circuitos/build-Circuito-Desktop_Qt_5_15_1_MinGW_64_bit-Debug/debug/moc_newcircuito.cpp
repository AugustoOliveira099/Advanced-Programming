...
QT_MOC_LITERAL(6, 55, 18), // "signMaximoEntradas"
QT_MOC_LITERAL(7, 74, 3), // "max"
QT_MOC_LITERAL(8, 78, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(9, 100, 21) // "on_buttonBox_rejected"

    },
    "newCircuito\0signNewCircuito\0\0nEntradas\0"
    "nSaidas\0nPortas\0signMaximoEntradas\0"
    "max\0on_buttonBox_accepted\0"
...
void newCircuito::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signMaximoEntradas((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (newCircuito::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newCircuito::signMaximoEntradas)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void newCircuito::signMaximoEntradas(int _t1)
{
